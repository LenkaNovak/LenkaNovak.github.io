...
<h2> Selection of my research </h2>
  ...
  <tr>
    ...
    <td>
      <h3>Jet shifts in latitude are modulated by growth of storms</h3>
      <p>
  ...
  <tr>
    ...
    <td>
      <h3>The response of storm tracks to temperature changes can be large even when their growth rate remains largely unchanged (multilayer dry global circulation model, PUMA)</h3>
      <p>
  ...
  <tr>
    ...
    <td>
      <h3>A model with no vertical structure can reproduce observed nonlinear suppressions in winter storminess (modelling using a one-layer barotropic model)</h3>
  ...
  <tr>
    ...
    <td>
      <h3>Ability to diagnose local potential energy available for turbulent motions locally</h3>
  ...
  <tr>
    ...
    <td>
      <h3>Extreme storminess occurs on monthly timescales</h3>
